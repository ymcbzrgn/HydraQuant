...
PARAM_REGISTRY: Dict[str, dict] = {
    ...
    # ─── PHASE 30 — Production hardening + forensics PARAMs ───
    "position_cap.single_pct":   {"organ": "phase30_risk", "default": 0.025, "min": 0.005, "max": 0.05,
                                   "regime_defaults": {"volatile": 0.018, "bull": 0.030}},
    "position_cap.aggregate_pct": {"organ": "phase30_risk", "default": 0.50, "min": 0.20, "max": 0.80,
                                   "regime_defaults": {"volatile": 0.30}},
    "anomaly.threshold_pct":     {"organ": "phase30_risk", "default": 0.05, "min": 0.02, "max": 0.15,
                                   "regime_defaults": {"volatile": 0.07, "ranging": 0.04}},
    "anomaly.cooldown_seconds":  {"organ": "phase30_risk", "default": 300,   "min": 60,    "max": 1800},
    "rag.fallback_on_timeout":   {"organ": "phase30_observability", "default": 1.0, "min": 0.0, "max": 1.0},
    "autonomy.diagnostic_enabled": {"organ": "phase30_observability", "default": 1.0, "min": 0.0, "max": 1.0},
    "autonomy.auto_promote":     {"organ": "phase30_observability", "default": 0.0, "min": 0.0, "max": 1.0},
    "restart_monitor.enabled":   {"organ": "phase30_observability", "default": 1.0, "min": 0.0, "max": 1.0},
    "promotion_gate.enabled":    {"organ": "phase30_promotion", "default": 1.0, "min": 0.0, "max": 1.0},
    "dry_divergence.daily_enabled": {"organ": "phase30_promotion", "default": 1.0, "min": 0.0, "max": 1.0},
    "shadow_kelly.auto_promote": {"organ": "phase30_promotion", "default": 0.0, "min": 0.0, "max": 1.0},
    "tool_loop.threshold":       {"organ": "phase30_observability", "default": 3, "min": 2, "max": 10},
    "tool_loop.window_sec":      {"organ": "phase30_observability", "default": 600, "min": 60, "max": 3600},
    "iteration_budget.parent_max": {"organ": "phase30_observability", "default": 6, "min": 2, "max": 20},
    "iteration_budget.child_max": {"organ": "phase30_observability", "default": 3, "min": 1, "max": 10},
    "iteration_budget.token_budget": {"organ": "phase30_observability", "default": 50000, "min": 10000, "max": 200000},
    "context_compressor.target_chars": {"organ": "phase30_observability", "default": 6000, "min": 1000, "max": 32000},
    "memory_decay.lambda":       {"organ": "phase30_observability", "default": 0.05, "min": 0.01, "max": 0.5},
    "llm_cache.ttl_seconds":     {"organ": "phase30_observability", "default": 21600, "min": 600, "max": 86400},
    "heartbeat_suppression.window_sec": {"organ": "phase30_observability", "default": 300, "min": 60, "max": 3600},
    "doom_loop.threshold":       {"organ": "phase30_observability", "default": 5, "min": 2, "max": 20},
    "doom_loop.window_sec":      {"organ": "phase30_observability", "default": 1800, "min": 300, "max": 7200},
    "calibrator.bypass":         {"organ": "phase30_promotion", "default": 1.0, "min": 0.0, "max": 1.0},
}
